...
uci set system.@system[0].hostname='DHL-OpenWrt'                            # 修改主机名称为OpenWrt-123
EOF

# 关闭IPv6 分配长度
sed -i '/ip6assign/d' package/base-files/files/bin/config_generate

sed -i 's/luci-theme-bootstrap/luci-theme-netgear/g' feeds/luci/collections/luci/Makefile           # 选择argon为默认主题
