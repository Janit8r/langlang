...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.2.100'                                    # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                                 # IPv4 子网掩码
uci set network.lan.gateway='192.168.2.4'                                   # IPv4 网关
...
uci set system.@system[0].hostname='DHL-OpenWrt'                             # 修改主机名称为Phicomm-N1
EOF
